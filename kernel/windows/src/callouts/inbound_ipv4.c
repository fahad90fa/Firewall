/*
 * Unified Firewall — FWPS_LAYER_INBOUND_IPPACKET_V4.
 *
...
VOID NTAPI UfwInboundIpv4ClassifyFn(
	...
	_Inout_ FWPS_CLASSIFY_OUT *classifyOut)
{
	...
	facts.isV6 = FALSE;
	facts.protocol = inFixedValues->incomingValue[FWPS_FIELD_INBOUND_IPPACKET_V4_IP_PROTOCOL].value.uint8;
...
NTSTATUS NTAPI UfwInboundIpv4NotifyFn(

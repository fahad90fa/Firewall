/*
 * Unified Firewall — FWPS_LAYER_INBOUND_IPPACKET_V6.
 *
...
VOID NTAPI UfwInboundIpv6ClassifyFn(
	...
	_Inout_ FWPS_CLASSIFY_OUT *classifyOut)
{
	...
	facts.isV6 = TRUE;
	facts.protocol = inFixedValues->incomingValue[FWPS_FIELD_INBOUND_IPPACKET_V6_IP_PROTOCOL].value.uint8;
...
NTSTATUS NTAPI UfwInboundIpv6NotifyFn(
